    ...
    return (
        ...
        <div id="flex justify-center flex-col">
                    ...
                    >
                        {({ isSubmitting }) => (
                            <Form className="flex justify-center flex-col w-full">
                                ...
                                <span className="flex justify-between mb-[50px]">
                                    ...
                                    <span className="flex flex-col">
                                        ...
                                        <Field type="tel" name="phone" id="phone" placeholder="Enter your phone number" />
            ...
            <div className="map">
                ...
                <p>2000 Rue Sainte-CatherineO, <br />
                    Montréal, QC H3H 2T3</p>
            </div>
